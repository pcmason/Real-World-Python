"""
Use NLP text extraction to summarize MLK's 'I Have a Dream' speech.
"""
...
# Step 1 - Define main() function to scrape webpage and assign speech to a var as a string
def main(text_url):
    # URL of MLK's speech
    url = text_url
    ...
    # Step 2 - Complete the main() function
...
# Step 4 - Calculating the frequency of occurrence of words
